...
apparel = Category.find_by(title: 'Apparel')
          ...
          .create([{ name: 'Hoody',
                   ...
                   { name: 'SODO JACKET',
                     description: 'The Admiral snowboard jacket protects with authority! The 37.5 technology by Cocona® offers 20K rated highly waterproof protection on the outside and manages moisture (sweat) while it's forming on the inside for next level breathability. This genius highly waterproof jacket comes complete with our ACT2 zonal insulation system, fully taped seams,YKK AquaGuard exposed zipper',
                     price: 190,
                     brand: 'Ride',
                     image: File.open('app/assets/images/sodo_jacket.png')
                   },
                   { name: '3.5L HOLMAN BIB',
                     description: 'We all love to do the snow dance, but no one loves to do the snow in my pants dance. We’ve taken the most functional outerwear garment you can have in extreme conditions, added 37.5 Technology to keep your body at an optimal moisture balance, reinforced the knees and butt for extra protection from the elements, and added a 4 way stretch lycra bib that gives you the freedom and comfort to be wedgie free no matter how much you tweak your grabs. This is the optimal pant to be snow-free for riders of all abilities.',
                     price: 125,
                     brand: 'Ride',
...
snowboards = Category.find_by(title: 'Snowboards')
             ...
             .create([{ name: 'gwar possum',
                      ...
                      { name: 'MACHETE GT WIDE SNOWBOARD',
                        description: 'The mountain is your playground on this surfy performance wide twin snowboard built for hitting features and locking in landings. All mountain freestyle snowboarders will benefit from the versatile Hybrid LowRize shape designed with the playful LowRize rocker in the tip and tail, and the responsive level micro-camber zone under foot. Featuring the latest in sidewall technology, Popwalls combine layers of carbon and Slimewalls material to maximize response, grip and stability, making this twin snowboard ideal for going big while maintaining an all around playful feel. ',
                        price: 455,
                        brand: 'Ride',
                        image: File.open('app/assets/images/machete_gt.png')
                      },
                      { name: 'WILD LIFE WIDE SNOWBOARD',
                        description: 'Joining forces with Ride engineers, team rider Marco Feichtner had a hand in refining this dialed ride. Delivering versatility for everything the mountain has to offer, the Wild Life wide snowboard features Ride’s All Mountain Rocker shape with playful LowRize rocker in the nose and the grippy stability of the flat zone under foot and through the tail. Complete with Slimewalls® sidewall, Carbon Array 3 laminates and Fusion 4000 base, this directional Ride will have you running wild from peak to park, with a responsive feel that won’t let you down.',
                        price: 600,
                        brand: 'Ride',
                        image: File.open('app/assets/images/wild_life.png')
                      },
                      { name: 'KINK SNOWBOARD',
                        description: 'The Kink got a facelift with a new shape, improved tech and art by the legendary, Sean Cliver. Twin Rocker and new Roll In Slimewalls make up the most durable board from the park to the streets.',
                        price: 430,
                        brand: 'Ride',
                        image: File.open('app/assets/images/kink.png')
                      },
                      { name: 'WWW SNOWBOARD',
                        description: 'The WWW continues its long history of creative jib progression. Carrying on it’s 2014 redesign into a second year it is a team go-to for looking at freestyle snowboarding in new and creative ways.',
                        price: 444,
                        brand: 'K2',
                        image: File.open('app/assets/images/www_144.png')
                      },
                      { name: 'FASTPLANT SNOWBOARD',
                        description: 'No other board pops harder and slashes heavier for longer than the K2 Fastplant. The primary freestyle ride for K2 team riders Jake Kuzyk and Matt Belzile, this Bambooyah powered all-mountain fresstyle deck balances power and technical finesse.',
                        price: 480,
                        brand: 'K2',
...
boots = Category.find_by(title: 'Boots')
        ...
        .create([{ name: 'cool boots',
                 ...
                 { name: 'TRIAD BOOTS',
                   description: 'The Triad strikes a chord with freestyle riders as the go to performance snowboard boot built to last. Featuring the Tongue Tied Boa closure system for next level heel hold and maximum control on a traditional lace snowboard boot. Blending top technologies such as the all new FlexLight outsole for better cushioning and custom fitting Intuition Mobile Foam Liner, these lightweight kicks prove durable and supportive, park lap after park lap.',
                   price: 230,
                   brand: 'Ride',
                   image: File.open('app/assets/images/triad_boots.png')
                 },
                 { name: 'HASHTAG BOOT',
                   description: 'K2’s Fast-In technology keeps things simple and quick so more time is spent actually snowboarding rather than fighting with a boot that would rather stay home.',
                   price: 170,
                   brand: 'K2',
...
bindings = Category.find_by(title: 'Bindings')
           ...
           .create([{ name: 'Foot Binders',
                    ...
                    { name: 'EX BINDINGS',
                      description: 'Built for versatility and durability, the EX snowboard binding features RIDE's all new aluminum Edge chassis to provide all-mountain performance and flex, and Wedgie footbeds for a boost of pop and support. Topped off with the ThinGrip Plus toe strap, RAM ankle strap and the AstroGlyde OG ratchets, you won’t find a better value for any level of rider.',
                      price: 200,
                      brand: 'Ride',
                      image: File.open('app/assets/images/ex_orange.png')
                    },
                    { name: 'LIEN AT BINDING',
                      description: 'Choice binding of K2 team riders such as Matt Belzile, the Lien AT represents a breakthrough in the balance of critical support and natural flex and movement. Built for the no-nonsense rider that wants bindings that move and support with you, not against you.',
                      price: 75,
                      brand: 'K2',
